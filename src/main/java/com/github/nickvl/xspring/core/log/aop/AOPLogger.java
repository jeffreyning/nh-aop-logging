...
public class AOPLogger implements InitializingBean {
    ...
    public Object logTheMethod(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if(logModule!=null){
            ...
            LogModule classModule=targetClass.getAnnotation(LogModule.class);
            if(classModule!=null){
                moduleName=classModule.value();
                replaceFlag=true;
            }
        }
...
//        }
        ...
        //add by ninghao
        String oldModule=MDC.get("bizModule");
        if(replaceFlag){
            MDC.put("bizModule", moduleName);
        }
